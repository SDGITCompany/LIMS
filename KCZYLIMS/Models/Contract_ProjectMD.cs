...
namespace KCZYLIMS.Models
{                    
			...
			public partial class Contract_ProjectMD : EntityMD                     
			{                       
				...
				{ 
					...
					set{ _AAAAAAAAAAAAAAAAA = value; }
										...
										String  _BuildScale = string.Empty;
							        
				public String BuildScale 
				{ 
					get{ return _BuildScale;  }
					set{ _BuildScale = value; }
				}
                   
				  
										String  _PrjGrade = string.Empty;
							        
				public String PrjGrade 
				{ 
					get{ return _PrjGrade;  }
					set{ _PrjGrade = value; }
				}
				...
				{ 
					...
					set{ _ClientLinkMan = value; }
										...
										String  _MainMajor = string.Empty;
							        
				public String MainMajor 
				{ 
					get{ return _MainMajor;  }
					set{ _MainMajor = value; }
				}
                   
				  
										DateTime  _PerformTime = DateTime.Now;
				...
				{ 
					...
					set{ _PerformTime = value; }
										...
										String  _TechManagerId = string.Empty;
							        
				public String TechManagerId 
				{ 
					get{ return _TechManagerId;  }
					set{ _TechManagerId = value; }
				}
                   
				  
										String  _TechManagerName = string.Empty;
							        
				public String TechManagerName 
				{ 
					get{ return _TechManagerName;  }
					set{ _TechManagerName = value; }
				}
                   
				  
										String  _TechManagerPhone = string.Empty;
							        
				public String TechManagerPhone 
				{ 
					get{ return _TechManagerPhone;  }
					set{ _TechManagerPhone = value; }
				}
