...
namespace KCZYLIMS.Models
{                    
			...
			public partial class vw_ProductSchedule_for_ExcuteMD : EntityMD                     
			{                       
				...
				{ 
					...
					set{ _ItemsMyStatus = value; }
										...
										String  _FlowProcess = string.Empty;
							        
				public String FlowProcess 
				{ 
					get{ return _FlowProcess;  }
					set{ _FlowProcess = value; }
				}
